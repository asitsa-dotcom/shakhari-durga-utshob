...
const translations: Record<string, Record<Language, string>> = {
  ...
  "emagazine.sidebar": { bn: "পৃষ্ঠা তালিকা", en: "Page sidebar", hi: "पृष्ठ सूची" },
  "emagazine.show_sidebar": { bn: "সাইডবার দেখান", en: "Show sidebar", hi: "साइडबार दिखाएँ" },
  "emagazine.hide_sidebar": { bn: "সাইডবার লুকান", en: "Hide sidebar", hi: "साइडबार छिपाएँ" },
